...
(function(document, Class, $) {
    ...
    $(document).on("click", relDamCreateFolder_1, initCreateDamFolder);
    ...
    var DamCreateFolder1 = new Class({
        ...
        initialize: function() {
			...
			Coral.commons.ready(self.createFolder_1, function() {
                self.createFolder_1
                    .on("click", function(event) {
                        var parentAPI = $(self.createFolder_1).closest(".foundation-toggleable")
                            .adaptTo("foundation-toggleable");
                        if (parentAPI) {
                            parentAPI.hide();
                        }
