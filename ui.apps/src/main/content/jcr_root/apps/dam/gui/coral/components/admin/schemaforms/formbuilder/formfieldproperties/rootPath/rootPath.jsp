...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("fieldLabel",   i18n.get("RootPath"));
    values.put("emptyText",    i18n.get("RootPath"));
    values.put("value",        cfg.get("rootPath", ""));
