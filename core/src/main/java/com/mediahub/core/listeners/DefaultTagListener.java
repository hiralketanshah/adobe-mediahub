...
@Component(service = {
        ...
        property = {
                ...
                ResourceChangeListener.PATHS + "=glob:" + DefaultTagListener.DEFAULT_TAGS + "**"// for handling custom invalidation for AF, AFF
        }
)

@ServiceDescription("listen on changes in the resource tree")
public class DefaultTagListener implements ResourceChangeListener {
