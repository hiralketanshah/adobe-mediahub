...
@Component(service = {
        ...
        property = {
                ...
                ResourceChangeListener.PATHS + "=glob:" + MediahubTagListener.DEFAULT_TAGS + "**"// for handling custom invalidation for AF, AFF
        }
)

@ServiceDescription("listen on changes in the resource tree")
public class MediahubTagListener implements ResourceChangeListener {

    public final static String DEFAULT_TAGS = "/content/cq:tags/mediahub/";
