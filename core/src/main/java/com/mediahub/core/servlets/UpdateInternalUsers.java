...
public class UpdateInternalUsers extends SlingAllMethodsServlet {
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
        ...
        try {
            ...
            if (null != remove && remove.equalsIgnoreCase("true")) {
                ...
                response.getWriter().write(updateInternalUsers.createAndUpdateUsers(csvUserFile, csvUserInfo, csvUserStatus, emailTo));
            }
    ...
    public @interface SchedulerConfig {
        ...
        @AttributeDefinition(name = "Email to send results to", description = "Results of the import will be sent to this email", type = AttributeType.STRING)
