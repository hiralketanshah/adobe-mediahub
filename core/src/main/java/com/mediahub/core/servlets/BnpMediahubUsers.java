...
@Component(
        ...
        property = {"sling.servlet.methods=" + HttpConstants.METHOD_GET,
                ServletResolverConstants.SLING_SERVLET_PATHS + "=" + "/bin/mediahub/users"
        })
public class BnpMediahubUsers extends SlingAllMethodsServlet {

    private static final Logger LOGGER = LoggerFactory.getLogger(BnpMediahubUsers.class);
    ...
    protected void doGet(final SlingHttpServletRequest request,
        ...
        try {
            ...
            Authorizable currentUserAuthorizable = um.getAuthorizable(request.getUserPrincipal());
            Value[] type = currentUserAuthorizable.getProperty("./profile/type");
            StringBuilder sb = new StringBuilder();
            if(type != null && type.length > 0 && StringUtils.equals(type[0].getString(), BnpConstants.EXTERNAL)){
                // To hide in case of external users.
            } else {
