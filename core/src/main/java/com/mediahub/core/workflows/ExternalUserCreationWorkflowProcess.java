...
public class ExternalUserCreationWorkflowProcess implements WorkflowProcess {
    ...
    public void execute(WorkItem item, WorkflowSession wfsession, MetaDataMap args) throws WorkflowException {
        ...
        logger.debug("ExternalUserCreationWorkflowProcess :: exceute method start");
        ...
        try {
            ...
            throw new WorkflowException("Error while creating external user", e);
        } finally {
        ...
        logger.debug("ExternalUserCreationWorkflowProcess :: exceute method end");
