    ...
    public void execute(WorkItem workItem, WorkflowSession workflowSession, MetaDataMap metaDataMap)
        ...
        try {
            ...
            if (null != movedAsset) {
                ...
                if (StringUtils.equalsIgnoreCase(modifiableValueMap.get("dam:scene7Type", StringUtils.EMPTY), "Video")) {
                ...
                } else if (StringUtils.equalsIgnoreCase(modifiableValueMap.get("dam:scene7Type", StringUtils.EMPTY), "MasterVideo")) {
                    String file = "is/content/" + modifiableValueMap.get("dam:scene7File", StringUtils.EMPTY);
                    modifiableValueMap.put("bnpp-external-broadcast-url", domain + "s7viewers/html5/VideoViewer.html?asset=" + URIUtil.encodePath(modifiableValueMap.get("dam:scene7FileAvs", StringUtils.EMPTY)));
                    modifiableValueMap.put("bnpp-external-file-url", domain + URIUtil.encodePath(file));
                } else {
